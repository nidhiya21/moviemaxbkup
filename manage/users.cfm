                                        ...
                                        <tbody>  
                                            <cfloop query="userList"> 
                                                <tr>
                                                    ...
                                                    <td> 
                                                        <a href="" class="delete modal-triggerUser icon-clr"   data-toggle="modal" data-id=#userList.userID# data-target=".deleteEmployeeModal">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content dltcontent">
                            <form action="" method="post">
                                <div class="modal-contentValUser">
