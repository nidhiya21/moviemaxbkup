    ...
    <div class="main-menu " >
        ...
        <div class="menu-desktop">
            <div class="search-box">
                <input class="search-input" type="text" id="search_term" name="search-term" placeholder="Search movies">
                <a  href = "javascript:;"  onclick = "this.href='./nowplaying.cfm?search=' + document.getElementById('search_term').value" class="search-btn">
