...
$(document).on('click', ".btnCheckout", function () { 
    ...
    var allowClick =parseInt(goldFullCount)+parseInt(goldHalfCount)+parseInt(odcFullCount)+parseInt(odcHalfCount)+parseInt(boxCount);
    var elements =  document.querySelectorAll('#odcFullCount .seatSelected');
    ...
    if(totalClick>allowClick){
        ...
        if((cnt>odcFullCount) ) { 
            alert("You have exceeded allowed seat limit");
        }
        else{ 
            $.ajax({
                type:"POST",   
