...
<html>
    ...
    <body>
        <cfoutput> 
            ...
            <cfset resultUsr=moviesObj.getUserDetails(variables.userID)/>   
            <section id="basic-page">
                <div class="main-content">
                    <div class="staticPage">
                        ...
                        <div class="col-md-9">
                            <cfset result=moviesObj.getOrderDetails(variables.userID)/> 
                            <cfset resultCnt=moviesObj.getBookingsCnt(variables.userID)/>
                            <cfif resultCnt.count eq 0> 	
								<div class="contact-list-cnt"> <span class="txt-title">You have no bookings.Please book latest movies for more offer! <span class=".smily">&##128577;</span></span></div>
							<cfelse>
								<div class="contact-list-cnt"> <span class="txt-title">Congradulations!You have  #resultCnt.count# recBookingsrds!  <span class=".smily">&##128578;</span></span></div>
							</cfif>  
                            <cfif resultCnt.count gt 0> 	 
                                <div class="profile-contents profile-content1">                            
