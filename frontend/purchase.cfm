...
<cfif structKeyExists(URL,'id')>
    <cfif URL.id NEQ "">
        <cfset variables.movieID =  Decrypt(URL.id, "abc!@")/>
        <cfset result=moviesObj.getMoviesById(movieID)/>   
    </cfif>
    <cfif URL.tid NEQ "">
        <cfset variables.theaterID =  Decrypt(URL.tid, "abc!@")/>
        <cfset res=moviesObj.getTheaterByID(theaterID)/>   
    </cfif>
    <cfif URL.sid NEQ "">
        <cfset variables.showID =  Decrypt(URL.sid, "abc!@")/> 
    </cfif>
    <cfif URL.slot NEQ "">
        <cfset variables.slot =  Decrypt(URL.slot, "abc!@")/> 
    </cfif>
    <cfif URL.date NEQ "">
        <cfset variables.date =  Decrypt(URL.date, "abc!@")/> 
    </cfif>
</cfif>
<!DOCTYPE html>
<html>
    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="page-body" >
                <cfoutput>
                    <input type="hidden" id="movieID" name="movieID" value= "#variables.movieID#"/>
                    <input type="hidden" id="theaterID" name="theaterID" value= "#variables.theaterID#"/>
                    <input type="hidden" id="showID" name="showID" value= "#variables.showID#"/> 
                    <input type="hidden" id="bookedTime" name="bookedTime" value= "#variables.slot#"/>
                    <input type="hidden" id="bookedDate" name="bookedDate" value= "#variables.date#"/> 
                            ...
                            <section class="film-details">
                                ...
                                <div class="film-details-body">
                                    <div class="showtime-info">
                                        ...
                                        <text>#variables.date#</text>
                                    </div>
                                    <div class="showtime-info">
                                        <label for="FilmLength">Time</label>
                                        <text for="FilmLength">#variables.slot#</text>
                                    </div>
                                    <div class="showtime-info">
