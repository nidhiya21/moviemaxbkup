                    ...
                    <div id="movie-list" class="flex-container flex-container-wrap">
                        ...
                        <cfloop query="movieList"> 
                            <div class="movie flex-item-stretch">
                                <a href="./details.cfm?id=#URLEncodedFormat(Encrypt(variables.movieList.movieID, encrptKey))#">
                                    <img src="../manage/movies/#movieList.fld_poster#" class="poster-portrait mobile-hide">
                                </a>
